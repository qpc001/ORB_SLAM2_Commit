...
public:
    ...
    //关于Tracking::mvIniMatches : 这个vector存储当前帧与参考帧匹配上的点的idx
    //即 mvIniMatches[参考帧特征点idx]=当前帧特征点idx
    ...
    list<cv::Mat> mlRelativeFramePoses;//为每一帧储存对应的参考关键帧及其相对的变换
...
protected:
    ...
    */
    ...
    //在OnlyTracking模式中使用
    //true表明在上一帧中匹配到了很少的mappoint (匹配数<10)
    bool mbVO;
